...
class Volunteer(models.Model):
    ...
    adminmark=models.CharField(max_length=300,null=True)
    regdate=models.DateTimeField(auto_now_add=True)
...
class Donation(models.Model):
    ...
    donationame=models.CharField(max_length=20,null=True)
    ...
    volremark=models.CharField(max_length=200,null=True)
    updationdate=models.DateField(null=True)
    def __str__(self):
        return str(self.id)
...
class Gallery(models.Model):
    ...
    deliverypic = models.ImageField(upload_to='gallery', max_length=300)
    creationdate=models.DateTimeField(auto_now_add=True)
    def __str__(self):
        return str(self.id)
