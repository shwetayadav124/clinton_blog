# Generated by Django 5.0.6 on 2024-05-12 17:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection_loc', models.CharField(max_length=100, null=True)),
                ('description', models.CharField(max_length=300, null=True)),
                ('donation_pic', models.ImageField(blank=True, null=True, upload_to='donation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('deliverypic', models.FileField(max_length=300, upload_to='')),
                ('creationdate', models.DateTimeField(auto_now_add=True)),
