...
urlpatterns = [
    ...
    path(
        "donationnotrec-detail/<int:pid>",
        views.donationnotrec_detail.as_view(),
        name="donationnotrec_detail"
    ),
    path(
    ...
    path('password-reset-email/',views.send_custom_email, name='send_custom_email'),
